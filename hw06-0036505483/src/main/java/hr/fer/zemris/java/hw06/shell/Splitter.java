	...
	private static class QLexer {
		...
		public String[] getArgs() {
			...
			for (int i = 0; i < args.size(); i++) {
				...
				// .trim() can ignore whitespaces that user inputted at the end of word, for
				// example he inserted " C:\Faks\Cpp "
				// Programm will trimm it to "C:\Faks\Cpp" because it avoids
				// InvalidPathException.
				// Windows does the same thing if you, for example, want to create file or
				// folder with whitespaces at the end
			}
			return toBeReturned;
		}
