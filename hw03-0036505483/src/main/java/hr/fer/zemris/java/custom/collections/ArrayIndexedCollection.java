...
public class ArrayIndexedCollection implements List {
	...
	public ElementsGetter createElementsGetter() {
		return new ArrayIndexedCollectionElementsGetter(elements, size, modificationCount, this);
	}

	/**
	 * Static class used to provide a iterator-like functionality. It takes a
	...
	private static class ArrayIndexedCollectionElementsGetter implements ElementsGetter {
		 ...
		 */
		private ArrayIndexedCollectionElementsGetter(Object[] elements, int numberOfElementsInArray,
				long modificationCount, ArrayIndexedCollection reference) {
