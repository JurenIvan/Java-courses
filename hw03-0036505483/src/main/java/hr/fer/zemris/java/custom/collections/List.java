...
public interface List extends Collection {
	...
	/**
	 * Returns the object that is stored in list at position index. Valid indexes
	...
	/**
	 * Method that inserts value into list at given index. Depending on position
	 * it can throw {@link IndexOutOfBoundsException} or if value is null (not
	 * allowed) it throws {@link NullPointerException}. 
	 * 
