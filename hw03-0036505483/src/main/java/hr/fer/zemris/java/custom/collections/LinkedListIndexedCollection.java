...
//		insert(value, this.size);		//Delegating results with cleaner code but it is slower to run due to sheer number of if statements in insert method that it has to go through
	...
	public ElementsGetter createElementsGetter() {
		return new LinkedListIndexedCollectionElementsGetter(first, size, modificationCount, this);
	}
	...
	private static class LinkedListIndexedCollectionElementsGetter implements ElementsGetter {
		 ...
		 */
		private ListNode nextNodeInList;
		/**
		 * Stores the reference to objects that we iterate through.
		 */
		private LinkedListIndexedCollection reference;
		...
		private LinkedListIndexedCollectionElementsGetter(ListNode first, int numberOfElementsInList,
				long modificationCount, LinkedListIndexedCollection reference) {
